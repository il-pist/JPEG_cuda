...
// output file
std::ofstream myFile1("test1_cuda.jpg", std::ios_base::out | std::ios_base::binary);
...
// output file
std::ofstream myFile2("test2_cuda.jpg", std::ios_base::out | std::ios_base::binary);
...
// output file
std::ofstream myFile3("test3_cuda.jpg", std::ios_base::out | std::ios_base::binary);
...
// output file
std::ofstream myFile4("test4_cuda.jpg", std::ios_base::out | std::ios_base::binary);
...
// output file
std::ofstream myFile5("test5_cuda.jpg", std::ios_base::out | std::ios_base::binary);
